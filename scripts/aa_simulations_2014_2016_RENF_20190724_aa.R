...
##### LIRE LES DEUX BASES (POINTS ET SUPERFICIES)
bd <- read.csv(paste0(datadir,"bd_1416_20190927.csv"))
...
table(ar$transition_clean,ar$class1416)
...
for(simulation in 1:30){
  ...
  write.csv(s1,paste0(datadir,"res_sim",simulation,"_2014_2016.csv"),row.names = F)  
