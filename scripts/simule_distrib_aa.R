...
rootdir <- "~ diaf_aa_2000_2010_2014/mes_scripts_aa/"
getwd <- "~ diaf_aa_2000_2010_2014/mes_scripts_aa/"
df0 <-read.csv ("bd_2000_2010_2014_v20190508.csv", sep = ";")
map_code <- "map_transition"
ref_code <- "ce_transition"

ar <- read.csv(paste0("area_00_10_14.csv", sep = ";"))
ar_code <- "change"
ar_area <- "area_ha"
