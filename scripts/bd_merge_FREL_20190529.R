...
write.csv(df0,paste0(datadir,"bd_2000_2010_2014_v20190531.csv"))
write.csv(nerf0010,paste0(datadir,"nerf_2000_2010_v20190531.csv"))
write.csv(nerf1014,paste0(datadir,"nerf_2010_2014_v20190531.csv"))
