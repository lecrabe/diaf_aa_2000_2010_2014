...
for(simulation in 1:30){
  ...
  write.csv2(s1,paste0(datadir,"res_sim",simulation,"_2010_2014.csv"),row.names = F)  
  
  write.csv2(df,paste0(datadir,"bd_simulation_",simulation,"_2010_2014_20200403.csv"),row.names= F)
