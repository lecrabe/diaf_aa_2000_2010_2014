...
df0 <- read.csv2(paste0(datadir,"bd_simulation_14_2000_2010_20200403.csv"))
...
write.csv(df0,paste0(datadir,"bd_filled_simulation_14_2000_2010_20200423.csv"))
...
for(province in unique(ar$NOM)){
  ...
  write.csv(d1,paste0(em_dir,"em_",province,"_0010.csv"),row.names = F)
...
write.csv(dd,paste0(datadir,"emissions_renf_2000_2010_20200423.csv"),row.names = F)
