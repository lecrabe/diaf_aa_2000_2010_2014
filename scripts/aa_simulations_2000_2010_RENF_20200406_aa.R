...
for(simulation in 1:30){
  ...
  write.csv2(s1,paste0(datadir,"res_sim",simulation,"_2000_2010.csv"),row.names = F)  
  
  write.csv2(df,paste0(datadir,"bd_simulation_",simulation,"_2000_2010_20200403.csv"),row.names= F)
