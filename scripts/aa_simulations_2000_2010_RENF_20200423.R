...
for(simulation in 1:30){
  ...
  df <- read.csv2(paste0(datadir,"bd_simulation_14_2000_2010_20200403.csv"))
  ...
  write.csv(s1,paste0(simdir,"verif_res_sim",simulation,"_2000_2010_20200423.csv"),row.names = F)  
  
  write.csv(df,paste0(simdir,"verif_bd_simulation_",simulation,"_2000_2010_20200423.csv"),row.names= F)
